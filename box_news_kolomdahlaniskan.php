...
?>
			...
			<div id="box_kolomdahlaniskan_wrapper">
			
				<div id="box_kolomdahlaniskan_title_wrapper">
					 <a href="<?php echo $link_kanal?>" id="box_kolomdahlaniskan_title_section"> <?php echo $detail_kanal->keterangan?> </a> 
					  
				</div>


<div id="box_kolomdahlaniskan_description_wrapper">
...
<a href="<?php echo $link_news_item?>" id="box_kolomdahlaniskan_item_image">  
<img id="box_kolomdahlaniskan_item_image" src="<?php echo $link_host?><?php echo $row_news_item->direktorigambar?><?php echo $row_news_item->gambarkecil?>"> 
</a> 

<a href="<?php echo $link_news_item?>" id="box_kolomdahlaniskan_item_judul"> <?php echo $row_news_item->judul?> </a> 
                            
<div id="box_kolomdahlaniskan_item_preview">
"<?php 
