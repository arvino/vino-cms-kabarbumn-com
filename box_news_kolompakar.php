...
?>
			...
			<div id="box_news_kolompakar_wrapper">
			
				<div id="box_news_kolompakar_title_wrapper">
					 <a href="<?php echo $link_kanal?>" id="box_news_kolompakar_title_section"> <?php echo $detail_kanal->keterangan?> </a> 
					 <a href="<?php echo $link_kanal_indeks?>" id="box_news_kolompakar_indeks"> <img src="<?php echo $link_host?>images/icon-indeks.png" /> </a>
				</div>


				<div id="box_news_kolompakar_description_wrapper">
...
<a href="<?php echo $link_news_item?>" id="box_news_kolompakar_item_image" >  
<img id="box_news_kolompakar_item_image" src="<?php echo $link_host?><?php echo $row_news_item->direktorigambar?><?php echo $row_news_item->gambarkecil?>"> 
</a> 

<a href="<?php echo $link_news_item?>" id="box_news_kolompakar_item_judul"> <?php echo $row_news_item->judul?> </a> 
                            

<div id="box_news_kolompakar_item_preview">
"<?php 
