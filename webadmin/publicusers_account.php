            ...
            <td width="78%"><div align="center">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr valign="top">
				  ...
				  <span class="JudulKanal_box1">MEMBER ACCOUNT</span>
                    <hr class='line_box'>
...
if(!isset($action)){
	...
	include"publicusers_form_register.php";
	...
	switch ($action){
		...
		Case 'publicusers_viewdetail': 
		include"publicusers_detail_item.php";
		break;
		
		Case 'publicusers_updatepassword':
		include"publicusers_form_gantipassword.php";
		break;
	
		Case 'publicusers_updateprofile': 
		include"publicusers_form_register.php";
		break;
