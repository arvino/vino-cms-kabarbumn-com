...
$otherpageFileHit = otherpagefileDiLihat( $tbl_otherpagefile, $id );
 

$_SESSION['filelampiran_$id_otherpagelog'] = $id_otherpagelog;
$_SESSION['id_otherpagelog'] = $id_otherpagelog;
...
<ul class="link_action">
	<li class="link_action"> <a href="javascript:location.reload(true)" class="link_action"> Refresh halaman </a> </li>
	<li class="link_action"> <a href="otherpage_filelampiran.php" class="link_action"> Close Window </a> </li>
</ul> </span>
<?php 
