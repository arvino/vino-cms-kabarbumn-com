         ...
         <td width="25%"><table width="250" border="0" cellspacing="0" cellpadding="0">
             ...
             <tr valign="top">
               ...
               <td background="images/box/B2_Latar.png">
                 <table class='tabelform'  align='center'  width='97%'  cellpadding='1' cellspacing='1'>
                   <tr class='kontenform'>
                     <td>
...
<br>
      ...
      Please fill out the form on the right side to reset your password.<br>
      Password will be sent to your email address, please check your email shortly after reset password. <br>
<br>
<br>
</div>
         ...
         <td width="75%"><div align="center">
             <table width="100%" border="0" cellspacing="0" cellpadding="0">
               ...
               <tr valign="top">
                 <td background="images/box/B2_Batas_Kiri.png" width="9"> </td>
                 <td background="images/box/B2_Latar.png"> <span class="JudulKanal_box1">RESET / LOST PASSWORD</span>
                     <hr class='line_box'>
                     <?php 
include"pesan_error.php";?>
                     <?php 
include"users_form_lupapassword.php";?>
                 </td>
                 <td background="images/box/B2_Batas_Kanan.png" width="8"> </td>
               </tr>
               <tr>
