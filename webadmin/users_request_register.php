...
<table class='tabelform' width='97%' align='center' cellpadding='1' cellspacing='1'>
...
PENDAFTARAN USERS</b>
					<br>
					Silahkan melakukan pendaftaran akun admin dengan mengisi form di sebelah kanan, 
					juga konfirmasikan pendaftaran anda dengan
					mengirim email ke <a href="mailto:webmaster@<?php 
echo strtolower($Config_Domain) ?>"> System Administrator </a>.
					<br>
					<br>
				</div>			</td>
		</tr>
            ...
            <td width="75%"><div align="center">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr valign="top">
				  ...
				  <span class="JudulKanal_box1">USERS REGISTRATION REQUEST </span>
                    <hr class='line_box'>
<?php 
include"pesan_error.php";?>
<?php 
include"users_form_request_register.php";?></td>
                  <td background="images/box/B2_Batas_Kanan.png" width="8"> </td>
                </tr>
                <tr>
                  <td width="9" height="8"><img name="B2_Sudut_KiriBawah" src="images/box/B2_Sudut_KiriBawah.png" width="9" height="8" border="0" alt=""></td>
