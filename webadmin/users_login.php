...
<div align='center'>
<br>
<b> LOG IN TO START ACCESS. </b> <br>
Please login first to continue. <br>
<br>
</div>
         ...
         <td width="75%"><div align="center">
             <table width="100%" border="0" cellspacing="0" cellpadding="0">
               ...
               <tr valign="top">
                 <td background="images/box/B2_Batas_Kiri.png" width="9"> </td>
                 <td background="images/box/B2_Latar.png"> <span class="JudulKanal_box1">LOGIN</span>
                     <hr class='line_box'>
                     <?php 
include"pesan_error.php";?>
                     <?php 
include"users_form_login.php";?>
                 </td>
                 <td background="images/box/B2_Batas_Kanan.png" width="8"> </td>
               </tr>
               <tr>
