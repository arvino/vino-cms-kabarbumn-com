...
$newsFileHit = newsfileDiLihat( $tbl_newsfile, $id );
 

$_SESSION['filelampiran_$id_newslog'] = $id_newslog;
$_SESSION['id_newslog'] = $id_newslog;
...
<ul class="link_action">
	...
	<li class="link_action"> <a href="javascript:window.close()" class="link_action"> Close Window </a> </li>
</ul>
</div>
...
* Please refresh this halaman or close and reopen if you can't see the file.
</td>
</tr>
<tr class='kontenform'>
<td>
...
<ul class="link_action">
	<li class="link_action"> <a href="javascript:location.reload(true)" class="link_action"> Refresh halaman </a> </li>
	<li class="link_action"> <a href="news_filelampiran.php" class="link_action"> Close Window </a> </li>
</ul> </span>
<?php 
