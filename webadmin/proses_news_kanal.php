...
if ((!in_array($KodeKeamananhalaman , $halamandiizinkan) OR !isset($KodeKeamananhalaman ))) {
	...
	header("location:news_kanal.php?pesan_error=ERROR !, YOU CAN'T DO THAT.");  
...
if( $keterangan =='' ){
	...
	header("location:news_kanal.php?pesan_error=PLEASE COMPLETE FILL THE TEXT BOX.");  
	
}else{

$id = newsKategori_CreateID( $tbl_newskategori ); 
$idupline = $idupline;
...
$posisi = $posisi;
	...
	if( $homepagetampil == "" || $homepagetampil == "none"){
		$homepagetampil = 0;
	}else{
		$homepagetampil = 1;
	}	
...
$sql_hitungdata = newsKategori_Periksaketerangan( $tbl_newskategori, $keterangan, $keteranganinggris );  
$hitung_data = mysql_num_rows($sql_hitungdata);
if( $hitung_data > 0 ){ 

	header("location:news_kanal.php?pesan_error=ERROR !, DUPLICATE NAME."); 
...
if( $image_file_logo == "" ){ /* JIka tida ada upload file logo */
	...
	$loc_root = "../";	
	$loc_file = "filemodul/news/file_kanal/";
...
/* Simpan data ke database */
	...
	header("location:news_kanal.php?pesan_error=SUCCESS SUBMIT DATA !.");  
}}}  
}
/* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- */
...
if( $keterangan=='' ){
	...
	header("location:news_kanal.php?action=EditData&idkategori=" . $idkategori . "&pesan_error=PLEASE FILL THE FORM COMPLETELY."); 
...
if( $hitung_data > 1 ){  
	...
	header("location:news_kanal.php?id=$id&action=EditData&pesan_error=FAILED !, DUPLICATE DATA.");  
...
newsKategori_UpdateData(
		...
		$hit, $linkjudul, $keyword
	 	...
	 	header("location:news_kanal.php?id=$id&action=EditData&pesan_error=SUCCESS SUBMIT DATA !."); 
...
if ((!in_array($KodeKeamananhalaman , $halamandiizinkan) OR !isset($KodeKeamananhalaman ))) {
	...
	//@//unlink($image_kanal);
	newsKategori_update_image_logo( $tbl_newskategori, $id );
	header("location:news_kanal.php?action=EditData&id=$id&pesan_error=SUCCESS DELETE IMAGE !."); 
}
}
...
if ((!in_array($KodeKeamananhalaman , $halamandiizinkan) OR !isset($KodeKeamananhalaman ))) {
	...
	//@//unlink($image_kanal);
	newsKategori_update_image_header( $tbl_newskategori, $id );
	header("location:news_kanal.php?action=EditData&id=$id&pesan_error=SUCCESS DELETE IMAGE."); 
}
}
...
if ((!in_array($KodeKeamananhalaman , $halamandiizinkan) OR !isset($KodeKeamananhalaman ))) {
	...
	//@//unlink($image_kanal);
	newsKategori_update_image_background( $tbl_newskategori, $id );
	header("location:news_kanal.php?action=EditData&id=$id&pesan_error=SUCCESS DELETE IMAGE !."); 
}
}
/* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- */
...
if ((!in_array($KodeKeamananhalaman , $halamandiizinkan) OR !isset($KodeKeamananhalaman ))) {
	...
	header("location:news_kanal.php?pesan_error=SUCCESS PUBLISH DATA."); 
}
}
/* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- */
...
if( $action=="kanal_homepagetampil" ){  
$KodeKeamananhalaman  = "token_news";
if ((!in_array($KodeKeamananhalaman , $halamandiizinkan) OR !isset($KodeKeamananhalaman ))) {
	header("location:news_kanal.php?pesan_error=FAILED !, ACCESS DENIED.");  
}else{
...
if ((!in_array($KodeKeamananhalaman , $halamandiizinkan) OR !isset($KodeKeamananhalaman ))) {
	...
	newsKategori_hapusdata( $tbl_newskategori, $id );
	header("location:news_kanal.php?pesan_error=SUCCESS DELETE DATA."); 
} 
}	
/* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- *//* ---- */
