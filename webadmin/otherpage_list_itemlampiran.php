...
?>
<tr class='kontenform'>
	<td colspan='3' class='kontenform'> NO EXTRA FILE FOUND. </td>
</tr>
<?php 
}else{
?>
...
$view_detail_lampiran_otherpage = "otherpage_item_detaillampiran.php?iditem=$row_filelampiran->idkonten&id=$row_filelampiran->id";
}
...
echo $view_detail_lampiran_otherpage ?>','printWindowFileLampiran<?php 
...
<a href='otherpage_item_lampiran.php?iditem=<?php 
...
[ CLICK HERE FOR VIEW EXTRA FILE ]
...
Read Count: <br> <?php 
echo  $row_filelampiran->hitcounter ?> <br><br>
