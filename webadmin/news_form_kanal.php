...
if($action=="EditData"){ 
	...
	if( $row_kanal->homepagetampil == "1"){ /* Status Tampil di Homehalaman */
		$cek_homepagetampil = "checked";
	}else{
		$cek_homepagetampil = "";
	}
...
<form action="<?php 
echo $FormnewsKategori_Action ?>" method="post" enctype="multipart/form-data" name="FormKanal" target="_self" id="FormKanal">
...
echo $cek_statustampil ?>>
    ...
    <tr class='kontenform' >
	  ...
	  <label>
	  <input name="homepagetampil" type="checkbox" id="homepagetampil" value="1" <?php 
echo $cek_homepagetampil ?>>
...
<br>
<a href='proses_news_kanal.php?action=kanal_updateimage_logo&id=<?php 
...
<br>
<a href='proses_news_kanal.php?action=kanal_updateimage_header&id=<?php 
...
<br>
<a href='proses_news_kanal.php?action=kanal_updateimage_background&id=<?php 
