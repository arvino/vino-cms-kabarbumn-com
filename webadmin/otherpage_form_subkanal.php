...
$Tombol_CANCEL = "<input type='reset' name='reset' value='CANCEL' class='button' onClick=\"javascript:location.replace('otherpage_kanal.php?idkategori=$idkategori&mode=SubSection')\" >";
...
<form action="<?php 
echo $FormotherpageKategoriSub_Action ?>" method="post" enctype="multipart/form-data" name="FormSubKanal" target="_self">
  ...
  <table width='100%'  align='center' cellpadding='1' cellspacing='1' class='tabelform'>
    <tr class='kontenform'>
      ...
      <td><?php 
echo $otherpagekategori_keterangan ?></td>
    </tr>
    <tr class='kontenform'>
...
<br>
<a href='proses_otherpage_subkanal.php?action=subkanal_updateimage_logo&id=<?php 
...
<br>
<a href='proses_otherpage_subkanal.php?action=subkanal_updateimage_header&id=<?php 
...
<br>
<a href='proses_otherpage_subkanal.php?action=subkanal_updateimage_background&id=<?php 
...
echo $row_subkanal->keteranganinggris ?>' size='50'>
      ...
      <td>
        <div align='left'>
          <input name='btn_otherpagesubkategori' type='submit' class='button' value='<?php 
echo $otherpagesubkategori_submitbutton ?>'>
          <?php 
