...
function Ambil_SubKategori(str1,str2){
	...
	xmlhttp.open("GET","order_tampilsubkategori.php?idkategori="+str1+"&idkategorisub="+str2,true);
	xmlhttp.send();
}
...
function JavaScript_Konfirmasi_Item( idkategori, idkategorisub, id ){
	...
	if (answer)
	window.location="proses_order_item.php?action=item_hapusdata&idkategori=" + idkategori + "&idkategorisub=" + idkategorisub + "&id=" + id
	else
	window.location="order_item.php?idkategori=" + idkategori + "&idsubkategori=" + idkategorisub + "&id=" + id + "&action=ViewList"
}
...
function JavaScript_Konfirmasi_ItemLampiran( iditem , id ){
	var answer = confirm ("Are you sure want to delete this file.")
	if (answer)
	window.location="proses_order_itemlampiran.php?action=itemlampiran_hapusdata&iditem="+  iditem  +"&id=" + id 
	else
	window.location="order_item_lampiran.php?iditem=" + iditem
}
...
function JavaScript_Konfirmasi_ItemKomentar( id, iditem ){
	var answer = confirm ("Are you sure want to delete this file.")
	if (answer)
	window.location="proses_order_itemkomentar.php?action=itemkomentar_hapusdata&iditem="+  iditem  +"&id=" + id 
	else
	window.location="order_item_komentar.php?iditem=" + iditem
}
            ...
            <td width="78%"><div align="center">
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr valign="top">
				  ...
				  <span class="JudulKanal_box1">LISTING ITEM order<?php 
