...
include"menu_news.php";?>
         ...
         <td width="78%"><div align="center">
             <table width="100%" border="0" cellspacing="0" cellpadding="0">
               ...
               <tr valign="top">
                 <td background="images/box/B2_Batas_Kiri.png" width="9"> </td>
                 <td background="images/box/B2_Latar.png"> <span class="JudulKanal_box1">NEWS ARTICLE EXTRA FILE</span>
                     <hr class='line_box'>
                     <?php 
...
<?php 
$iditem = $_GET['iditem'];
$row_item = Select_Detail_Item_news($tbl_news, $iditem);
if( !isset($action) ){
	$FormnewsItemLampiran_Action = "proses_news_itemlampiran.php?action=itemlampiran_tambahdata";
	$newskategori_submitbutton = "Tambah Lampiran...";
	$Tombol_CANCEL = "<input type='reset' name='reset' value='CANCEL' class='button' onClick=\"javascript:location.replace('news_item_lampiran.php?iditem=$iditem')\" >";
}


if( $action == "EditData" ){
	$id = $_GET['id'];
	$FormnewsItemLampiran_Action = "proses_news_itemlampiran.php?action=itemlampiran_updatedata";
	$newskategori_submitbutton = "Update Lampiran...";
	$Tombol_CANCEL = "<input type='reset' name='reset' value='CANCEL' class='button' onClick=\"javascript:location.replace('news_item_lampiran.php?iditem=$iditem')\" >";
...
<?php 
include"menu_news2.php";?>
                     <br>
<?php 
include"news_preview_item.php";?>
                     <br>
<?php 
include"news_list_itemlampiran.php";?>
                     <br>
<?php 
include"news_form_itemlampiran.php";?>
<?php 
} ?>             
