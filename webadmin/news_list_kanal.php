...
<td width="671" colspan="5" class='judulform'> LIST NEWS ARTICLE SECTION </td>
</tr>
<?php 
$result = mysql_query("SELECT * FROM $tbl_newskategori ORDER BY urutan");
...
<div class="link_action">
  <ul>
	<li> <a href='news_kanal.php?id=<?php 
...
/*
 ...
 if($row->statustampil == 0){
	$Publish = "<a href='proses_news_kanal.php?action=kanal_statustampil&id=$row->id&status=1' class='link_action'> Publish </a>";
	$Unpublish = "Unpublish";
}else{
	$Publish = "Publish";
	$Unpublish = "<a href='proses_news_kanal.php?action=kanal_statustampil&id=$row->id&status=0' class='link_action'> Unpublish </a>";
}
...
if($row->menutampil == 0){
	$Publish = "<a href='proses_news_kanal.php?action=kanal_menutampil&id=$row->id&status=1' class='link_action'> Publish </a>";
	$Unpublish = "Unpublish";
}else{
	$Publish = "Publish";
	$Unpublish = "<a href='proses_news_kanal.php?action=kanal_menutampil&id=$row->id&status=0' class='link_action'> Unpublish </a>";
}
?>
...
if($row->menutampil2 == 0){
	$Publish = "<a href='proses_news_kanal.php?action=kanal_menutampil2&id=$row->id&status=1' class='link_action'> Publish </a>";
	$Unpublish = "Unpublish";
}else{
	$Publish = "Publish";
	$Unpublish = "<a href='proses_news_kanal.php?action=kanal_menutampil2&id=$row->id&status=0' class='link_action'> Unpublish </a>";
}
?>
...
if($row->homehalamantampil == 0){
	$Publish = "<a href='proses_news_kanal.php?action=kanal_homehalamantampil&id=$row->id&status=1' class='link_action'> Publish </a>";
	$Unpublish = "Unpublish";
}else{
	$Publish = "Publish";
	$Unpublish = "<a href='proses_news_kanal.php?action=kanal_homehalamantampil&id=$row->id&status=0' class='link_action'> Unpublish </a>";
}
