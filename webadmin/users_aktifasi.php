       ...
       <tr valign="top">
               ...
               <td background="images/box/B2_Latar.png">
                 <table class='tabelform' width='97%' align='center' cellpadding='1' cellspacing='1'>
                   <tr class='kontenform'>
                     <td>
                       <div align='center'> <br>
                           <b> AKTIFASIKAN PENDAFTARAN. </b> <br>
                    Silahkan memasukkan KODE AKTIFASI <br>
                    yang di kirim ke alamat email anda. <br>
                    Untuk dapat memulai akses.<br>
                    <br>
                     </div></td>
                   </tr>
               </table></td>
         ...
         <td width="75%"><div align="center">
             <table width="100%" border="0" cellspacing="0" cellpadding="0">
               ...
               <tr valign="top">
                 <td background="images/box/B2_Batas_Kiri.png" width="9"> </td>
                 <td background="images/box/B2_Latar.png"> <span class="JudulKanal_box1">AKTIFASI PENDAFTARAN</span>
                     <hr class='line_box'>
                     <?php 
include"pesan_error.php";?>
                     <?php 
include"users_form_aktifasi.php";?>
                 </td>
                 <td background="images/box/B2_Batas_Kanan.png" width="8"> </td>
               </tr>
               <tr>
