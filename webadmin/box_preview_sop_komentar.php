...
<?php 
$result = LihatDatasopKomentarLimited( $tbl_sopkomentar );
$hitungdata = HitungTotalAllDatasopKomentar( $tbl_sopkomentar );
?>
<?php 
if($hitungdata == 0){
?>
...
$detail_sop_item = Select_Detail_Item_sop($tbl_sop, $row_komentar->idkonten);
...
echo $no ?>. 
<?php 
echo $detail_sop_item->judul ?><br> 

<?php 
echo $detail_user->username ?> :
<a href='sop_item.php?idkategori=<?php 
echo $detail_sop_item->idkategori ?>&idsubkategori=<?php 
echo $detail_sop_item->idkategorisub ?>&id=<?php 
echo $detail_sop_item->id ?>&action=ViewDetail'>
<?php 
