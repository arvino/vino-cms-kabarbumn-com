...
<?php 
$result_itemlampiran = ViewAll_bannerItemLampiran_ByItem( $tbl_bannerfile, $iditem );
$hitungdata = TotalAllDatabannerItemLampiran( $tbl_bannerfile, $iditem );
?>
<?php 
if($hitungdata == 0){
?>
...
$view_detail_lampiran_banner = "banner_item_detaillampiran.php?iditem=$row_filelampiran->idkonten&id=$row_filelampiran->id";
}
...
$scrollbar = "scrollbars=yes";
$LokasiFile = "../" . $row_filelampiran->direktorifile . $row_filelampiran->namafile;
//$view_detail_lampiran_banner = "$LokasiFile";
$view_detail_lampiran_banner = "banner_item_detaillampiran.php?iditem=$row_filelampiran->idkonten&id=$row_filelampiran->id";
}
...
echo $view_detail_lampiran_banner ?>','printWindowFileLampiran<?php 
...
<a href='banner_item_lampiran.php?iditem=<?php 
...
<br>
Di baca : <br> <?php 
echo $row_filelampiran->hitcounter  ?> kali
<br>
</div>
